...
import 'package:flutter_playout_example/services/shared_preferences_service.dart';
...
class InitAppService {
  static initializeDevice() async {
    ...
    if (deviceModel.toLowerCase().contains('amazon')) {
      ...
      /// set amazon appstore app url here
      // appStoreUrl = '';
    }
  ...
  static initApp() async {
    ...
    await Utils.askAndroidStoragePermission();
  }
}
